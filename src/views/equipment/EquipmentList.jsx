        ...
        <div style={{ maxWidth: '1280px', margin: '0 auto', padding: '24px 32px' }}>
          <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-4">
            ...
            <button
              ...
              className="w-full lg:w-auto flex items-center justify-center gap-3 px-6 py-3 bg-gradient-to-r from-blue-600 to-indigo-600 text-white rounded-2xl font-semibold text-base hover:from-blue-700 hover:to-indigo-700 transition-all duration-300 shadow-lg hover:shadow-2xl transform hover:-translate-y-1"
            >
      ...
      <div style={{ padding: '32px', maxWidth: '1280px', margin: '0 auto' }}>
        {equipment.length === 0 ? (
          <div className="relative overflow-hidden">
            ...
            <div className="relative bg-white/80 backdrop-blur-xl rounded-3xl shadow-2xl border border-gray-200/50 p-12 text-center">
              <div className="max-w-lg mx-auto space-y-6">
                <div className="inline-flex items-center justify-center w-24 h-24 bg-gradient-to-br from-blue-100 to-indigo-100 rounded-3xl shadow-xl">
                  <svg className="w-12 h-12 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4" />
                  </svg>
                </div>
                <h3 className="text-3xl font-bold text-gray-900">No Equipment Yet</h3>
                ...
                <button
                  onClick={() => navigate('/equipment/add')}
                  className="inline-flex items-center justify-center gap-3 px-8 py-4 bg-gradient-to-r from-blue-600 to-indigo-600 text-white rounded-2xl font-bold text-lg hover:from-blue-700 hover:to-indigo-700 transition-all duration-300 shadow-xl hover:shadow-2xl transform hover:-translate-y-1"
                >
              ...
              >
                ...
                <div className="relative bg-white/90 backdrop-blur-sm shadow-xl border border-gray-200/60 rounded-3xl overflow-hidden hover:shadow-2xl transition-all duration-500">
                  ...
                  <div className="absolute top-5 right-5 z-10">
                    {item.isScrapped ? (
                      <span className="inline-flex items-center gap-2 px-3 py-1.5 bg-red-500 text-white text-xs font-bold rounded-full shadow-lg uppercase tracking-wider">
                        <span className="w-2 h-2 bg-white rounded-full animate-pulse"></span>
                        Scrapped
                      </span>
                    ) : (
                      <span className="inline-flex items-center gap-2 px-3 py-1.5 bg-gradient-to-r from-green-500 to-emerald-500 text-white text-xs font-bold rounded-full shadow-lg uppercase tracking-wider">
                        <span className="w-2 h-2 bg-white rounded-full animate-pulse"></span>
                        Active
                      </span>
                    )}
                  ...
                  <div className="relative p-5 bg-gradient-to-br from-gray-50 to-white border-b border-gray-100">
                    <h3 className="text-xl font-bold text-gray-900 leading-tight pr-20">
                      {item.name}
                    </h3>
                  ...
                  <div className="p-5 space-y-4">
                    {/* Department */}
                    <div className="flex items-center gap-3 p-3 bg-gradient-to-br from-blue-50 to-blue-100/50 rounded-xl border border-blue-200/50">
                    ...
                    {/* Location */}
                    <div className="flex items-center gap-3 p-3 bg-gradient-to-br from-purple-50 to-purple-100/50 rounded-xl border border-purple-200/50">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      {!item.isScrapped && (
                        <button
                          ...
                          className="flex items-center justify-center gap-2 px-4 py-2.5 bg-gradient-to-r from-yellow-500 to-orange-500 text-white rounded-xl font-bold text-sm hover:from-yellow-600 hover:to-orange-600 transition-all duration-300 shadow-md hover:shadow-lg transform hover:-translate-y-0.5"
                        >
                      ...
                      <button
                        ...
                        className={`flex items-center justify-center gap-2 px-4 py-2.5 bg-gradient-to-r from-red-500 to-red-600 text-white rounded-xl font-bold text-sm hover:from-red-600 hover:to-red-700 transition-all duration-300 shadow-md hover:shadow-lg transform hover:-translate-y-0.5 ${
